...
import Animated, { Extrapolation, SharedValue, interpolate, useAnimatedStyle, useSharedValue, withTiming } from 'react-native-reanimated';
...
const ScrollDot = () => {
  ...
  const onScroll = (event: NativeSyntheticEvent<NativeScrollEvent>) => {
    aniIndex.value = withTiming(event.nativeEvent.contentOffset.x / width, { duration: 0 })
  }
