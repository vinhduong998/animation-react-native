...
import Animated, { Extrapolation, clamp, interpolate, runOnJS, useAnimatedRef, useAnimatedStyle, useDerivedValue, useSharedValue, withDecay, withSequence, withSpring, withTiming } from 'react-native-reanimated';
interface Props {
...
const WIDTH_SLIDE = width - 60
const WIDTH_TINT = 40
const HEIGHT_SLIDE = 4
const RATIO_SCALE = 3 / 4

const BallonSlider = (props: Props) => {
