...
const AnimatedChild = ({
  ...
  const stylez = useAnimatedStyle(() => {
    // if (index ===0) {
    //   console.log("left", index * (textWidth.value + spacing))
    //   console.log("translateX", -(anim.value % (textWidth.value + spacing)))
    // }
    return {
      position: 'absolute',
 ...
 */
const Marquee = ({ speed = 1, children, spacing = 0, style }: MarqueeProps) => {
